          ...
          <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
              ...
              <div class="hidden md:block md:mr-10 md:pl-4 md:space-s-8">
                ...
                <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors py-2 px-4 rounded-lg bg-indigo-50 hover:bg-indigo-100">ورود به حساب کاربری</a>
              </div>
            </nav>
          </div>
